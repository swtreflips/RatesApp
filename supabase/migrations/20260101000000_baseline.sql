...
CREATE OR REPLACE FUNCTION "public"."cache_within_miles"("a" "text", "b" "text", "miles" double precision DEFAULT 100) RETURNS boolean
...
ALTER FUNCTION "public"."cache_within_miles"("a" "text", "b" "text", "miles" double precision) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."current_role_is"("target" "text") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."current_role_is"("target" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_forwarder_recipients"("p_forwarder_ids" "uuid"[]) RETURNS TABLE("forwarder_id" "uuid", "forwarder_name" "text", "email" "text")
    LANGUAGE "sql" STABLE SECURITY DEFINER
...
ALTER FUNCTION "public"."get_forwarder_recipients"("p_forwarder_ids" "uuid"[]) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_recipients_by_analyst"("p_analyst_ids" "uuid"[]) RETURNS TABLE("forwarder_id" "uuid", "forwarder_name" "text", "analyst_id" "uuid", "email" "text")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'auth'
    AS $$
...
ALTER FUNCTION "public"."get_recipients_by_analyst"("p_analyst_ids" "uuid"[]) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_service_directory"("p_forwarder_ids" "uuid"[], "p_service" "text") RETURNS TABLE("forwarder_id" "uuid", "forwarder_name" "text", "analyst_id" "uuid", "analyst_name" "text", "email" "text", "tag_ocean" boolean, "tag_drayage" boolean)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'auth'
    AS $$
  select f.id, f.name, p.id,
...
ALTER FUNCTION "public"."get_service_directory"("p_forwarder_ids" "uuid"[], "p_service" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."my_forwarder"() RETURNS "uuid"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."my_forwarder"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_geom"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
...
ALTER FUNCTION "public"."set_geom"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_route_geom"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
...
ALTER FUNCTION "public"."set_route_geom"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."drayage_rate_benchmarks" (
...
ALTER TABLE "public"."drayage_rate_benchmarks" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."drayage_rates" (
    ...
    "last_cy_cfs" "text" NOT NULL,
    "final_destination" "text" NOT NULL,
    "drayage_lane" "text" GENERATED ALWAYS AS ((("last_cy_cfs" || ' - '::"text") || "final_destination")) STORED,
    "dest_zip" "text",
    "rate" numeric(12,2) NOT NULL,
    "fuel_surcharge_pct" numeric(6,4),
    "fuel_surcharge" numeric(12,2),
    "fuel_surcharge_amount" numeric(12,2) GENERATED ALWAYS AS (COALESCE("fuel_surcharge", "round"(("rate" * "fuel_surcharge_pct"), 2), (0)::numeric)) STORED,
    "fuel_surcharge_pct_eff" numeric(6,4) GENERATED ALWAYS AS (
CASE
    WHEN ("fuel_surcharge_pct" IS NOT NULL) THEN "fuel_surcharge_pct"
    WHEN (("fuel_surcharge" IS NOT NULL) AND ("rate" > (0)::numeric)) THEN "round"(("fuel_surcharge" / "rate"), 4)
    ELSE (0)::numeric
END) STORED,
    "total_rate" numeric(12,2) GENERATED ALWAYS AS (("rate" + COALESCE("fuel_surcharge", "round"(("rate" * "fuel_surcharge_pct"), 2), (0)::numeric))) STORED,
    "toll_fee" numeric(12,2),
    "pre_pull_fee" numeric(12,2),
    "pier_pass_fee" numeric(12,2),
    "clean_truck_fee" numeric(12,2),
    "drop_fee" numeric(12,2),
    "chassis_fee" numeric(12,2),
    "min_chassis_days" integer,
    "chassis_days_included" integer,
    "storage_fee_per_day" numeric(12,2),
    "provided_at" "date" DEFAULT CURRENT_DATE NOT NULL,
    "confirmed_at" "date" DEFAULT CURRENT_DATE NOT NULL,
    "notes" "text",
    "status" "text" DEFAULT 'current'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "port_congestion_fee" numeric(12,2),
    "chassis_split_fee" numeric(12,2),
    "demurrage_fee" numeric(12,2),
    CONSTRAINT "drayage_rates_status_check" CHECK (("status" = ANY (ARRAY['current'::"text", 'superseded'::"text"])))
);


ALTER TABLE "public"."drayage_rates" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."drayage_request_lanes" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "drayage_request_lanes_kind_check" CHECK (("kind" = ANY (ARRAY['new'::"text", 'refresh'::"text"])))
);


ALTER TABLE "public"."drayage_request_lanes" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."drayage_routes" (
    ...
    "base_duration_s" integer,
    "typical_duration_s" integer,
    "polyline" "text" NOT NULL,
    "transport_mode" "text" DEFAULT 'truck'::"text" NOT NULL,
    "provider" "text" DEFAULT 'here'::"text" NOT NULL,
    "origin_geom" "public"."geography"(Point,4326),
    "dest_geom" "public"."geography"(Point,4326),
    "created_at" timestamp with time zone DEFAULT "now"()
);


ALTER TABLE "public"."drayage_routes" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."drayage_submissions" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "lane_id" "uuid",
    "forwarder_id" "uuid" NOT NULL,
    "provider_id" "uuid" NOT NULL,
    ...
    CONSTRAINT "drayage_submissions_status_check" CHECK (("status" = ANY (ARRAY['submitted'::"text", 'skipped'::"text"])))
);


ALTER TABLE "public"."drayage_submissions" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."forwarder_services" (
    "forwarder_id" "uuid" NOT NULL,
    "service" "text" NOT NULL,
    "active" boolean DEFAULT true NOT NULL,
    CONSTRAINT "forwarder_services_service_check" CHECK (("service" = ANY (ARRAY['ocean'::"text", 'drayage'::"text"])))
);


ALTER TABLE "public"."forwarder_services" OWNER TO "postgres";
...
ALTER TABLE "public"."forwarders" OWNER TO "postgres";
...
COMMENT ON TABLE "public"."geocode_cache" IS 'stores cache data about us locations returned by nominatim api';



CREATE TABLE IF NOT EXISTS "public"."graph_credentials" (
...
ALTER TABLE "public"."graph_credentials" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."notification_recipients" (
    ...
    "analyst_id" "uuid",
    CONSTRAINT "notification_recipients_status_check" CHECK (("status" = ANY (ARRAY['queued'::"text", 'sent'::"text", 'failed'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."notifications" (
    ...
    "period" integer,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "service" "text" DEFAULT 'ocean'::"text" NOT NULL,
    CONSTRAINT "notifications_kind_check" CHECK (("kind" = ANY (ARRAY['request'::"text", 'reminder'::"text"]))),
    CONSTRAINT "notifications_service_check" CHECK (("service" = ANY (ARRAY['ocean'::"text", 'drayage'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "company" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "receives_rate_requests" boolean DEFAULT true NOT NULL,
    "receives_drayage_requests" boolean DEFAULT true NOT NULL,
    CONSTRAINT "profiles_role_check" CHECK (("role" = ANY (ARRAY['internal'::"text", 'forwarder'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."rate_request_batches" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "requester_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "service" "text" DEFAULT 'ocean'::"text" NOT NULL,
    CONSTRAINT "rate_request_batches_service_check" CHECK (("service" = ANY (ARRAY['ocean'::"text", 'drayage'::"text"])))
);


ALTER TABLE "public"."rate_request_batches" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rate_request_lanes" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "batch_id" "uuid" NOT NULL,
    "pol" "text" NOT NULL,
    "fd" "text" NOT NULL,
...
ALTER TABLE "public"."rate_request_lanes" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."rate_submissions" (
    ...
    "skip_reason" "text",
    "submitted_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "rate_submissions_status_check" CHECK (("status" = ANY (ARRAY['submitted'::"text", 'skipped'::"text"])))
);


ALTER TABLE "public"."rate_submissions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."rates" (
    ...
    "contract" "text",
    "contractname" "text",
    "container_type" "text" DEFAULT '40'' HC'::"text" NOT NULL
);
...
COMMENT ON TABLE "public"."us_ports" IS 'us ports and yard data';



ALTER TABLE ONLY "public"."drayage_rate_benchmarks"
    ADD CONSTRAINT "drayage_rate_benchmarks_pkey" PRIMARY KEY ("rate_id");



ALTER TABLE ONLY "public"."drayage_rates"
    ADD CONSTRAINT "drayage_rates_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."drayage_request_lanes"
    ADD CONSTRAINT "drayage_request_lanes_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."drayage_routes"
    ADD CONSTRAINT "drayage_routes_pkey" PRIMARY KEY ("origin_query", "destination_query");



ALTER TABLE ONLY "public"."drayage_submissions"
    ADD CONSTRAINT "drayage_submissions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."forwarder_services"
    ADD CONSTRAINT "forwarder_services_pkey" PRIMARY KEY ("forwarder_id", "service");



ALTER TABLE ONLY "public"."forwarders"
    ADD CONSTRAINT "forwarders_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."graph_credentials"
    ADD CONSTRAINT "graph_credentials_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."rate_request_batches"
    ADD CONSTRAINT "rate_request_batches_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rate_request_lanes"
    ADD CONSTRAINT "rate_request_lanes_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rate_submissions"
    ADD CONSTRAINT "rate_submissions_pkey" PRIMARY KEY ("id");
...
CREATE UNIQUE INDEX "drayage_rates_current_uq" ON "public"."drayage_rates" USING "btree" ("forwarder_id", "last_cy_cfs", "final_destination") WHERE ("status" = 'current'::"text");



CREATE INDEX "drayage_routes_dest_geom_idx" ON "public"."drayage_routes" USING "gist" ("dest_geom");



CREATE INDEX "drayage_routes_origin_geom_idx" ON "public"."drayage_routes" USING "gist" ("origin_geom");



CREATE UNIQUE INDEX "drayage_subs_unique_linked" ON "public"."drayage_submissions" USING "btree" ("lane_id", "forwarder_id") WHERE ("lane_id" IS NOT NULL);



CREATE INDEX "geocode_cache_geom_idx" ON "public"."geocode_cache" USING "gist" ("geom");



CREATE INDEX "idx_drayage_lanes_expires" ON "public"."drayage_request_lanes" USING "btree" ("expires_at");



CREATE INDEX "idx_drayage_rates_forwarder" ON "public"."drayage_rates" USING "btree" ("forwarder_id");



CREATE INDEX "idx_drayage_rates_lane" ON "public"."drayage_rates" USING "btree" ("lane_id");



CREATE INDEX "idx_drayage_subs_forwarder" ON "public"."drayage_submissions" USING "btree" ("forwarder_id");



CREATE INDEX "idx_drayage_subs_lane" ON "public"."drayage_submissions" USING "btree" ("lane_id");



CREATE INDEX "idx_lanes_expires" ON "public"."rate_request_lanes" USING "btree" ("expires_at");



CREATE INDEX "idx_lanes_pol_fd" ON "public"."rate_request_lanes" USING "btree" ("pol", "fd");



CREATE INDEX "idx_notif_recipients_analyst" ON "public"."notification_recipients" USING "btree" ("analyst_id");



CREATE INDEX "idx_notif_recipients_forwarder" ON "public"."notification_recipients" USING "btree" ("forwarder_id");



CREATE INDEX "idx_rates_forwarder" ON "public"."rates" USING "btree" ("forwarder_id");



CREATE INDEX "idx_rates_lane" ON "public"."rates" USING "btree" ("lane_id");



CREATE INDEX "idx_rates_pol_fd" ON "public"."rates" USING "btree" ("pol", "fd");



CREATE INDEX "idx_submissions_forwarder" ON "public"."rate_submissions" USING "btree" ("forwarder_id");



CREATE INDEX "idx_submissions_lane" ON "public"."rate_submissions" USING "btree" ("lane_id");



CREATE UNIQUE INDEX "idx_submissions_unique_linked" ON "public"."rate_submissions" USING "btree" ("lane_id", "forwarder_id", "period") WHERE ("lane_id" IS NOT NULL);



CREATE INDEX "us_ports_geom_idx" ON "public"."us_ports" USING "gist" ("geom");



CREATE OR REPLACE TRIGGER "trg_set_geom" BEFORE INSERT OR UPDATE ON "public"."geocode_cache" FOR EACH ROW EXECUTE FUNCTION "public"."set_geom"();



CREATE OR REPLACE TRIGGER "trg_set_geom" BEFORE INSERT OR UPDATE ON "public"."us_ports" FOR EACH ROW EXECUTE FUNCTION "public"."set_geom"();



CREATE OR REPLACE TRIGGER "trg_set_route_geom" BEFORE INSERT OR UPDATE ON "public"."drayage_routes" FOR EACH ROW EXECUTE FUNCTION "public"."set_route_geom"();



ALTER TABLE ONLY "public"."drayage_request_lanes"
    ADD CONSTRAINT "drayage_lanes_refresh_of_fkey" FOREIGN KEY ("refresh_of") REFERENCES "public"."drayage_rates"("id");



ALTER TABLE ONLY "public"."drayage_rate_benchmarks"
    ADD CONSTRAINT "drayage_rate_benchmarks_rate_id_fkey" FOREIGN KEY ("rate_id") REFERENCES "public"."drayage_rates"("id");



ALTER TABLE ONLY "public"."drayage_rates"
    ADD CONSTRAINT "drayage_rates_forwarder_id_fkey" FOREIGN KEY ("forwarder_id") REFERENCES "public"."forwarders"("id");



ALTER TABLE ONLY "public"."drayage_rates"
    ADD CONSTRAINT "drayage_rates_lane_id_fkey" FOREIGN KEY ("lane_id") REFERENCES "public"."drayage_request_lanes"("id");



ALTER TABLE ONLY "public"."drayage_rates"
    ADD CONSTRAINT "drayage_rates_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."drayage_rates"
    ADD CONSTRAINT "drayage_rates_submission_id_fkey" FOREIGN KEY ("submission_id") REFERENCES "public"."drayage_submissions"("id");



ALTER TABLE ONLY "public"."drayage_request_lanes"
    ADD CONSTRAINT "drayage_request_lanes_batch_id_fkey" FOREIGN KEY ("batch_id") REFERENCES "public"."rate_request_batches"("id");



ALTER TABLE ONLY "public"."drayage_submissions"
    ADD CONSTRAINT "drayage_submissions_forwarder_id_fkey" FOREIGN KEY ("forwarder_id") REFERENCES "public"."forwarders"("id");



ALTER TABLE ONLY "public"."drayage_submissions"
    ADD CONSTRAINT "drayage_submissions_lane_id_fkey" FOREIGN KEY ("lane_id") REFERENCES "public"."drayage_request_lanes"("id");



ALTER TABLE ONLY "public"."drayage_submissions"
    ADD CONSTRAINT "drayage_submissions_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."forwarder_services"
    ADD CONSTRAINT "forwarder_services_forwarder_id_fkey" FOREIGN KEY ("forwarder_id") REFERENCES "public"."forwarders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."notification_recipients"
    ADD CONSTRAINT "notification_recipients_analyst_id_fkey" FOREIGN KEY ("analyst_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."notification_recipients"
    ADD CONSTRAINT "notification_recipients_forwarder_id_fkey" FOREIGN KEY ("forwarder_id") REFERENCES "public"."forwarders"("id");
...
ALTER TABLE ONLY "public"."profiles"
    ADD CONSTRAINT "profiles_forwarder_id_fkey" FOREIGN KEY ("forwarder_id") REFERENCES "public"."forwarders"("id");
...
ALTER TABLE ONLY "public"."rate_request_batches"
    ADD CONSTRAINT "rate_request_batches_requester_id_fkey" FOREIGN KEY ("requester_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."rate_request_lanes"
    ADD CONSTRAINT "rate_request_lanes_batch_id_fkey" FOREIGN KEY ("batch_id") REFERENCES "public"."rate_request_batches"("id");



ALTER TABLE ONLY "public"."rate_submissions"
    ADD CONSTRAINT "rate_submissions_forwarder_id_fkey" FOREIGN KEY ("forwarder_id") REFERENCES "public"."forwarders"("id");



ALTER TABLE ONLY "public"."rate_submissions"
    ADD CONSTRAINT "rate_submissions_lane_id_fkey" FOREIGN KEY ("lane_id") REFERENCES "public"."rate_request_lanes"("id");



ALTER TABLE ONLY "public"."rate_submissions"
    ADD CONSTRAINT "rate_submissions_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."rates"
    ADD CONSTRAINT "rates_forwarder_id_fkey" FOREIGN KEY ("forwarder_id") REFERENCES "public"."forwarders"("id");



ALTER TABLE ONLY "public"."rates"
    ADD CONSTRAINT "rates_lane_id_fkey" FOREIGN KEY ("lane_id") REFERENCES "public"."rate_request_lanes"("id");



ALTER TABLE ONLY "public"."rates"
    ADD CONSTRAINT "rates_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."rates"
    ADD CONSTRAINT "rates_submission_id_fkey" FOREIGN KEY ("submission_id") REFERENCES "public"."rate_submissions"("id");



ALTER TABLE "public"."drayage_rate_benchmarks" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."drayage_rates" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."drayage_request_lanes" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."drayage_routes" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."drayage_submissions" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "forwarder deletes drayage rates" ON "public"."drayage_rates" FOR DELETE USING (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder deletes drayage submissions" ON "public"."drayage_submissions" FOR DELETE USING (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder deletes rates" ON "public"."rates" FOR DELETE USING (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder deletes submissions" ON "public"."rate_submissions" FOR DELETE USING (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder inserts drayage rates" ON "public"."drayage_rates" FOR INSERT WITH CHECK ((("forwarder_id" = "public"."my_forwarder"()) AND ("provider_id" = "auth"."uid"())));



CREATE POLICY "forwarder inserts drayage submissions" ON "public"."drayage_submissions" FOR INSERT WITH CHECK ((("forwarder_id" = "public"."my_forwarder"()) AND ("provider_id" = "auth"."uid"())));



CREATE POLICY "forwarder inserts rates" ON "public"."rates" FOR INSERT WITH CHECK ((("forwarder_id" = "public"."my_forwarder"()) AND ("provider_id" = "auth"."uid"())));



CREATE POLICY "forwarder inserts submissions" ON "public"."rate_submissions" FOR INSERT WITH CHECK ((("forwarder_id" = "public"."my_forwarder"()) AND ("provider_id" = "auth"."uid"())));



CREATE POLICY "forwarder reads drayage rates" ON "public"."drayage_rates" FOR SELECT USING (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder reads drayage submissions" ON "public"."drayage_submissions" FOR SELECT USING (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder reads rates" ON "public"."rates" FOR SELECT USING (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder reads submissions" ON "public"."rate_submissions" FOR SELECT USING (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder updates drayage rates" ON "public"."drayage_rates" FOR UPDATE USING (("forwarder_id" = "public"."my_forwarder"())) WITH CHECK (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder updates drayage submissions" ON "public"."drayage_submissions" FOR UPDATE USING (("forwarder_id" = "public"."my_forwarder"())) WITH CHECK (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder updates rates" ON "public"."rates" FOR UPDATE USING (("forwarder_id" = "public"."my_forwarder"())) WITH CHECK (("forwarder_id" = "public"."my_forwarder"()));



CREATE POLICY "forwarder updates submissions" ON "public"."rate_submissions" FOR UPDATE USING (("forwarder_id" = "public"."my_forwarder"())) WITH CHECK (("forwarder_id" = "public"."my_forwarder"()));
...
CREATE POLICY "forwarders read drayage lanes" ON "public"."drayage_request_lanes" FOR SELECT USING ("public"."current_role_is"('forwarder'::"text"));
...
ALTER TABLE "public"."graph_credentials" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "internal drayage lanes" ON "public"."drayage_request_lanes" USING ("public"."current_role_is"('internal'::"text")) WITH CHECK ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "internal reads benchmarks" ON "public"."drayage_rate_benchmarks" FOR SELECT USING ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "internal reads drayage rates" ON "public"."drayage_rates" FOR SELECT USING ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "internal reads drayage submissions" ON "public"."drayage_submissions" FOR SELECT USING ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "internal reads notification_recipients" ON "public"."notification_recipients" FOR SELECT USING ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "internal reads notifications" ON "public"."notifications" FOR SELECT USING ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "internal updates drayage rates" ON "public"."drayage_rates" FOR UPDATE USING ("public"."current_role_is"('internal'::"text")) WITH CHECK ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "internal updates drayage submissions" ON "public"."drayage_submissions" FOR UPDATE USING ("public"."current_role_is"('internal'::"text")) WITH CHECK ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "internal writes benchmarks" ON "public"."drayage_rate_benchmarks" FOR INSERT WITH CHECK ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "internal writes drayage rates" ON "public"."drayage_rates" FOR INSERT WITH CHECK (("public"."current_role_is"('internal'::"text") AND ("provider_id" = "auth"."uid"())));



CREATE POLICY "internal writes drayage submissions" ON "public"."drayage_submissions" FOR INSERT WITH CHECK (("public"."current_role_is"('internal'::"text") AND ("provider_id" = "auth"."uid"())));
...
CREATE POLICY "providers read lanes" ON "public"."rate_request_lanes" FOR SELECT USING ("public"."current_role_is"('forwarder'::"text"));



ALTER TABLE "public"."rate_request_batches" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."rate_request_lanes" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "read forwarders" ON "public"."forwarders" FOR SELECT USING (("auth"."role"() = 'authenticated'::"text"));



CREATE POLICY "read services" ON "public"."forwarder_services" FOR SELECT USING ((("forwarder_id" = "public"."my_forwarder"()) OR "public"."current_role_is"('internal'::"text")));



CREATE POLICY "requester batches" ON "public"."rate_request_batches" USING ("public"."current_role_is"('internal'::"text")) WITH CHECK ((("requester_id" = "auth"."uid"()) AND "public"."current_role_is"('internal'::"text")));



CREATE POLICY "requester lanes" ON "public"."rate_request_lanes" USING ("public"."current_role_is"('internal'::"text")) WITH CHECK ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "requester reads rates" ON "public"."rates" FOR SELECT USING ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "requester reads submissions" ON "public"."rate_submissions" FOR SELECT USING (("public"."current_role_is"('internal'::"text") AND ("lane_id" IS NOT NULL)));



CREATE POLICY "requester updates submissions" ON "public"."rate_submissions" FOR UPDATE USING ("public"."current_role_is"('internal'::"text")) WITH CHECK ("public"."current_role_is"('internal'::"text"));



CREATE POLICY "requester writes rates" ON "public"."rates" FOR INSERT WITH CHECK (("public"."current_role_is"('internal'::"text") AND ("provider_id" = "auth"."uid"())));



CREATE POLICY "requester writes submissions" ON "public"."rate_submissions" FOR INSERT WITH CHECK (("public"."current_role_is"('internal'::"text") AND ("provider_id" = "auth"."uid"())));



ALTER TABLE "public"."us_ports" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."cache_within_miles"("a" "text", "b" "text", "miles" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."cache_within_miles"("a" "text", "b" "text", "miles" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."cache_within_miles"("a" "text", "b" "text", "miles" double precision) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."current_role_is"("target" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."current_role_is"("target" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."current_role_is"("target" "text") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_forwarder_recipients"("p_forwarder_ids" "uuid"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_forwarder_recipients"("p_forwarder_ids" "uuid"[]) TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_recipients_by_analyst"("p_analyst_ids" "uuid"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_recipients_by_analyst"("p_analyst_ids" "uuid"[]) TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_service_directory"("p_forwarder_ids" "uuid"[], "p_service" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_service_directory"("p_forwarder_ids" "uuid"[], "p_service" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."my_forwarder"() TO "anon";
GRANT ALL ON FUNCTION "public"."my_forwarder"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."my_forwarder"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."set_geom"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_geom"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_geom"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_route_geom"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_route_geom"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_route_geom"() TO "service_role";
...
GRANT ALL ON TABLE "public"."drayage_rate_benchmarks" TO "anon";
GRANT ALL ON TABLE "public"."drayage_rate_benchmarks" TO "authenticated";
GRANT ALL ON TABLE "public"."drayage_rate_benchmarks" TO "service_role";



GRANT ALL ON TABLE "public"."drayage_rates" TO "anon";
GRANT ALL ON TABLE "public"."drayage_rates" TO "authenticated";
GRANT ALL ON TABLE "public"."drayage_rates" TO "service_role";



GRANT ALL ON TABLE "public"."drayage_request_lanes" TO "anon";
GRANT ALL ON TABLE "public"."drayage_request_lanes" TO "authenticated";
GRANT ALL ON TABLE "public"."drayage_request_lanes" TO "service_role";



GRANT ALL ON TABLE "public"."drayage_routes" TO "anon";
GRANT ALL ON TABLE "public"."drayage_routes" TO "authenticated";
GRANT ALL ON TABLE "public"."drayage_routes" TO "service_role";



GRANT ALL ON TABLE "public"."drayage_submissions" TO "anon";
GRANT ALL ON TABLE "public"."drayage_submissions" TO "authenticated";
GRANT ALL ON TABLE "public"."drayage_submissions" TO "service_role";



GRANT ALL ON TABLE "public"."forwarder_services" TO "anon";
GRANT ALL ON TABLE "public"."forwarder_services" TO "authenticated";
GRANT ALL ON TABLE "public"."forwarder_services" TO "service_role";



GRANT ALL ON TABLE "public"."forwarders" TO "anon";
GRANT ALL ON TABLE "public"."forwarders" TO "authenticated";
GRANT ALL ON TABLE "public"."forwarders" TO "service_role";
...
GRANT ALL ON TABLE "public"."graph_credentials" TO "anon";
GRANT ALL ON TABLE "public"."graph_credentials" TO "authenticated";
GRANT ALL ON TABLE "public"."graph_credentials" TO "service_role";
...
GRANT ALL ON TABLE "public"."rate_request_batches" TO "anon";
GRANT ALL ON TABLE "public"."rate_request_batches" TO "authenticated";
GRANT ALL ON TABLE "public"."rate_request_batches" TO "service_role";



GRANT ALL ON TABLE "public"."rate_request_lanes" TO "anon";
GRANT ALL ON TABLE "public"."rate_request_lanes" TO "authenticated";
GRANT ALL ON TABLE "public"."rate_request_lanes" TO "service_role";



GRANT ALL ON TABLE "public"."rate_submissions" TO "anon";
GRANT ALL ON TABLE "public"."rate_submissions" TO "authenticated";
GRANT ALL ON TABLE "public"."rate_submissions" TO "service_role";
